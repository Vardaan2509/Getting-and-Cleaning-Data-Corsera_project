...
#4. extract data by columns & using descriptive name
...
#5. generate final tidy data set
meltedData <- melt(allData, id = c("Subject", "Activity"))
tidyData <- dcast(meltedData, Subject + Activity ~ variable, mean)

#The txt file containing the final tidy data set.
